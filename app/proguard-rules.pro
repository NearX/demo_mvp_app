# AddsatisfactionDialog project specific ProGuard rules here.
# You can control the set of applied configuration files using the
# proguardFiles setting in build.gradle.
#
# For more_arrow details, see
...
-keep public class com.ybkj.demo.R$*{
...
-keep class com.ybkj.demo.ui.adapter.base.**{*;}
-keep class com.ybkj.demo.net.**{*;}


-keep class com.ybkj.demo.common.Constants
