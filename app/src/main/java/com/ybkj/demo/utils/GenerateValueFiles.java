...
public class GenerateValueFiles {
    ...
    private static final String SUPPORT_DIMESION = "320,480;480,800;480,854;540,960;600,1024;720,1184;720,1196;720,"
            + "1208;720,1200;720," + "1280;768,1024;800,1280;1080,1776;1080,1794;1080,1800;1080,1812;1080,1920;1440," +
            "2560;1200,1920;1200,1838;";
    private int baseW;
    private int baseH;
...
//        int baseH = 667;
    ...
    private void generateXmlFile(int w, int h) {
        ...
        sbForWidth.append(WTemplate.replace("{0}", 0.5 + "").replace("{1}", change(cellw * 0.5f) + ""));
        ...
        sbForHeight.append(HTemplate.replace("{0}", 0.5 + "").replace("{1}", change(cellh * 0.5f) + ""));
